...
class Video_thumbnail extends ModuleObject
{
	/**
	...
	protected static $_insert_triggers = [
		...
		[ 'document.updateDocument', 'after', 'triggerAfterUpdateDocument' ],
		[ 'document.deleteDocument', 'after', 'triggerAfterDeleteDocument' ]
	];
	 ...
	 * 모델 인스턴스를 가져옵니다.
	 *
	 * @return Video_thumbnailModel
	 */
	protected function getModel(): self
	{
		return Video_thumbnailModel::getInstance();
	}

	/**
	 * 컨트롤러 인스턴스를 가져옵니다.
	 *
	 * @return Video_thumbnailController
	 */
	protected function getController(): self
	{
		return Video_thumbnailController::getInstance();
	}

	/**
	 * 뷰 인스턴스를 가져옵니다.
	 *
	 * @return Video_thumbnailView
	 */
	protected function getView(): self
	{
		return Video_thumbnailView::getInstance();
	}

	/**
	 * 관리자 모델 인스턴스를 가져옵니다.
	 *
	 * @return Video_thumbnailAdminModel
	 */
	protected function getAdminModel(): self
	{
		return Video_thumbnailAdminModel::getInstance();
	}

	/**
	 * 관리자 컨트롤러 인스턴스를 가져옵니다.
	 *
	 * @return Video_thumbnailAdminController
	 */
	protected function getAdminController(): self
	{
		return Video_thumbnailAdminController::getInstance();
	}

	/**
	 * 관리자 뷰 인스턴스를 가져옵니다.
	 *
	 * @return Video_thumbnailAdminView
	 */
	protected function getAdminView(): self
	{
		return Video_thumbnailAdminView::getInstance();
	}
